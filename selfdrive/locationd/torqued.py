...
class TorqueEstimator(ParameterEstimator):
  def __init__(self, CP, decimated=False):
    ...
    self.min_lataccel_factor = 1.5      #    self.min_lataccel_factor = (1.0 - self.factor_sanity) * self.offline_latAccelFactor
    self.max_lataccel_factor = 3.0     #    self.max_lataccel_factor = (1.0 + self.factor_sanity) * self.offline_latAccelFactor
    self.min_friction = 0.07                 #    self.min_friction = (1.0 - self.friction_sanity) * self.offline_friction
    self.max_friction = 0.18                #    self.max_friction = (1.0 + self.friction_sanity) * self.offline_friction
