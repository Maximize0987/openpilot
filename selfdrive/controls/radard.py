...
RADAR_TO_CAMERA = 1.78  # RADAR is ~ 1.5m ahead from center of mesh frame
...
def get_lead(v_ego: float, ready: bool, tracks: dict[int, Track], lead_msg: capnp._DynamicStructReader,
  ...
  if len(tracks) > 0 and ready and lead_msg.prob > .6:     # old = .5
  ...
  elif (track is None) and ready and (lead_msg.prob > .6):     # old = .5
