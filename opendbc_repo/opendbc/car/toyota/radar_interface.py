...
yoffset = np.array([0.0, 0.2], dtype=np.float32)
ydistin = np.array([-2.0, -0.5, -0.3, 0.0, 0.3, 0.5, 2.0], dtype=np.float32)
ydistout = np.array([-3.0, -0.7, -0.3, 0.0, 0.3, 0.7, 3.0], dtype=np.float32)
