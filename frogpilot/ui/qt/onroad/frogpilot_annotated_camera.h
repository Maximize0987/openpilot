...
public:
  ...
  void paintLeadMetrics(QPainter &p, bool adjacent, QPointF *chevron, const cereal::CarState::Reader &carState, const cereal::FrogPilotPlan::Reader &frogpilotPlan, const cereal::RadarState::LeadData::Reader &lead_data);
